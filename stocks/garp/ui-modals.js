...
export const STRUCTURED_DILIGENCE_QUESTIONS = {
    'Financial Analysis': 'Describe the company\'s overall financial story and investment narrative. Focus on the core tension between its reputation for profitability and its recent growth challenges. What are the primary qualitative risks and opportunities this presents for the near future, and what is the general outlook on its market position?',
    'Balance Sheet': 'Tell the story of the company\'s financial foundation as seen through its balance sheet. How would you characterize its approach to risk, its reliance on debt, and its ability to cover immediate obligations? What does its management of company shares suggest about their long-term priorities and confidence?',
    'Income Statement': 'Describe the narrative of the company\'s profitability based on its income statement. Is the company becoming more or less efficient at turning revenue into actual profit? What does the relationship between its sales and final earnings tell you about its core business health and any emerging operational pressures?',
    'Cash Flow': 'Explain the company's cash flow story in simple terms. Where does its cash primarily come from—its core business or other means? And where is that cash going—back into the business, to investors, or elsewhere? What does this pattern of cash generation and spending reveal about management's strategic vision',
    'Institutional Ownership': 'Characterize the sentiment among the company\'s major investors. What's the underlying story behind the high ownership by prestigious firms on one hand, and their recent selling activity on the other? Does the investor base seem to be passively holding or actively betting on the company\'s future, and what does this suggest about their collective conviction?',
    'Competitors': 'Describe the company\'s standing within its competitive landscape. In broad terms, how does it stack up against its peers in market perception and overall strategy? Based on this comparison, what appear to be its key reputational strengths and weaknesses, and which competitor seems most similar in its business approach?'
};
