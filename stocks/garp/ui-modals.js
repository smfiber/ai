...
export const STRUCTURED_DILIGENCE_QUESTIONS = {
    ...
    'Competitors': 'Conduct a competitive analysis to benchmark MGY against this peer group and the industry average. Based on the available metrics, evaluate MGY\'s relative position in terms of valuation, stock performance, and scale. What does this comparison reveal about MGY\'s competitive advantages or disadvantages, and which company emerges as its most direct competitor?'
};
