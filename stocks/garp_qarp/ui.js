...
export function setupEventListeners() {
    ...
    analysisModal.addEventListener('click', async (e) => {
        ...
        if (target.id === 'save-qualitative-diligence-button') {
            handleQualitativeDiligenceSave(symbol);
            return;
        }
