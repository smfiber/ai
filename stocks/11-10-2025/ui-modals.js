...
function _resetAnalysisModal() {
    ...
    document.getElementById('scorecard-tab')?.classList.add('hidden'); // <-- NEW
...
export async function openRawDataViewer(ticker) {
    ...
    try {
        ...
        scorecardContainerTab = document.getElementById('scorecard-tab'); // <-- NEW
        ...
        if (dashboardTab) {
            ...
            // --- START: NEW SCORECARD TAB POPULATION ---
            if (scorecardContainerTab) {
                ...
                // Helper to get raw metric values for calculations
                ...
                const psrG = (psRatio !== null && revGrowth5Y !== null && revGrowth5Y !== 0) ? `${(psRatio / (revGrowth5Y * 100)).toFixed(2)}` : 'N/A'; // revGrowth5Y is a decimal
                const implied1YGrowth = (peRatio !== null && fwdPE !== null && fwdPE !== 0) ? `${(((peRatio / fwdPE) - 1) * 100).toFixed(2)}%` : 'N/A';

                scorecardContainerTab.innerHTML = `
                    <h2 class="text-2xl font-bold text-gray-800 mb-4">Quantitative Scoring Analysis (56 / 100)</h2>
                    <p class="mb-6 text-gray-700">
                        This company profiles as a high-quality, consistently profitable business whose score is severely penalized by 
                        <strong>high financial risk</strong> (heavy debt, low interest coverage) and a <strong>mediocre valuation</strong>.
                    </p>
                    ...
                    <table class="score-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <strong>CRITICAL RISK.</strong> At 1.56, earnings barely cover interest. An economic dip could be catastrophic.
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                ...
                                <td>10 pts</td>
                                <td>3 / 10</td>
                                <td><strong>High.</strong> 1.69 is a high leverage ratio, amplifying both gains (ROE) and risk.</td>
                            </tr>
                            <tr class="subtotal-row">
                                <td colspan="3"><strong>Financial Health Subtotal</strong></td>
                                <td colspan="2"><strong>8 / 30</strong></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>10 pts</td>
                                <td>10 / 10</td>
                                <td><strong>Excellent.</strong> 33.47% is a very high return for shareholders.</td>
                            </tr>
                            <tr>
                                <td></td>
                                ...
                                <td>10 pts</td>
                                <td>4 / 10</td>
                                <td><strong>Mediocre.</strong> 8.73% proves the high ROE is from leverage, not operational excellence.</td>
                            </tr>
                            <tr>
                                <td></td>
                                <td>Cash Flow Conversion (${fcfConversion})</td>
                                <td>5 pts</td>
                                <td>5 / 5</td>
                                <td><strong>Excellent.</strong> At 1.09x, FCF is stronger than net income.</td>
                            </tr>
                            <tr>
                                <td></td>
                                ...
                                <td>5 pts</td>
                                <td>5 / 5</td>
                                <td><strong>Excellent.</strong> Perfect consistency.</td>
                            </tr>
                            <tr class="subtotal-row">
                                <td colspan="3"><strong>Profitability Subtotal</strong></td>
                                <td colspan="2"><strong>24 / 30</strong></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>10 pts</td>
                                <td>4 / 10</td>
                                <td><strong>Fair to Expensive.</strong> 1.91 is nearly double the "cheap" benchmark of 1.0.</td>
                            </tr>
                            <tr>
                                <td></td>
                                ...
                                <td>10 pts</td>
                                <td>4 / 10</td>
                                <td><strong>Fair.</strong> 20.34 (or a 4.9% FCF Yield) is not a bargain.</td>
                            </tr>
                            <tr>
                                <td></td>
                                ...
                                <td>5 pts</td>
                                <td>3 / 5</td>
                                <td><strong>Fair.</strong> 2.93 is reasonable for a ~13% net margin.</td>
                            </tr>
                            <tr class="subtotal-row">
                                <td colspan="3"><strong>Valuation Subtotal</strong></td>
                                <td colspan="2"><strong>11 / 25</strong></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>5 pts</td>
                                <td>5 / 5</td>
                                <td><strong>Excellent.</strong> 0.06 is very stable and predictable.</td>
                            </tr>
                            <tr>
                                <td></td>
                                ...
                                <td>5 pts</td>
                                <td>4 / 5</td>
                                <td><strong>Good.</strong> 11.53% is solid, compounding growth.</td>
                            </tr>
                            <tr>
                                <td></td>
                                ...
                                <td>5 pts</td>
                                <td>4 / 5</td>
                                <td><strong>Good.</strong> 9.52% shows consistent top-line expansion.</td>
                            </tr>
                            <tr class="subtotal-row">
                                <td colspan="3"><strong>Growth Subtotal</strong></td>
                                <td colspan="2"><strong>13 / 15</strong></td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="score-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Sign of high-quality earnings (FCF > Net Income).</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="risk-critical">The extra return generated by using debt. **Warning:** Low interest coverage.</td>
                            </tr>
                             <tr>
                                <td><strong>PSR/G Ratio</strong></td>
                                <td>(P/S) / (Rev. Growth 5Y %)</td>
                                <td><strong>${psrG}</strong></td>
                                <td>Potentially attractive valuation relative to sales growth.</td>
                            </tr>
                            <tr>
                    ...
                    <div class="prose prose-sm max-w-none bg-white p-4 rounded-md border">
                        <p>
                            An investment firm would likely <strong>Pass</strong> on this stock. The score of <strong>56</strong> reflects a company that 
                            <em>looks</em> great on the surface (high growth, high ROE) but is fundamentally flawed underneath.
                        </p>
                        <p>
                            <strong>Investment Thesis:</strong> "This is a 'levered-up' growth story. You are paying a high price (low valuation score) 
                            for a mediocre-quality business (low ROIC) that is taking on a dangerous amount of debt (low financial health score) 
                            to produce its growth and returns."
                        </p>
                    </div>
                `;
            }
            // --- END: NEW SCORECARD TAB POPULATION ---
