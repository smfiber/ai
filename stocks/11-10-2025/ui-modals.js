 ...
 */
function _generateScorecardAnalysisHtml(metrics) {
    ...
    const scores = {
        ...
        quality: [
            ...
            getMetricScore('Quarterly Earnings Progress', 5), // Renamed from Cash Flow Conversion
    ...
    try {
        ...
        if (dashboardTab) {
            ...
            if (scorecardContainerTab) {
                scorecardContainerTab.innerHTML = _generateScorecardAnalysisHtml(metrics);
            }
