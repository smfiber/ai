...
[Your 2-3 sentence justification here. Your reasoning must connect the fundamental thesis from `{latestThesisContent}` with the valuation context from `{currentPrice}` and your position's P/L.]
---
`.trim();
